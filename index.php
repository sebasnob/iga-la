                  ...
                  <div class="overlay-content">
                    <div class="overlay-text">
                      <div class="folio-info">
                        <h3>DESTACADO</h3>
                        <p>Gastronomía, Alta Cocina</p>
                      </div>
                      <div class="folio-overview">
                        <span class="folio-link"><a  href="cursos.html" target="blank" data-single_url="cursos.html"><i class="fa fa-link"></i></a></span>
                       <span class="folio-expand "><a class="folio-read-more" href="#single-portfolio" data-toggle="collapse"><i class="fa fa-search-plus"></i></a></span>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="overlay-content">
                    <div class="overlay-text">
                      <div class="folio-info">
                        ...
                        <p>Certificación Avanzada en Gastronomía</p>
                      </div>
                      <div class="folio-overview">
                         <span class="folio-link"><a  href="cursos.html" target="blank" data-single_url="cursos.html"><i class="fa fa-link"></i></a></span>
                        <span class="folio-expand"><a class="folio-read-more" href="#single-portfolio" data-toggle="collapse"><i class="fa fa-search-plus"></i></a></span>
                ...
                <div class="overlay">
                  <div class="overlay-content">
                    <div class="overlay-text">
                      <div class="folio-info">
                        <h3>DESTACADO</h3>
                        <p>Gastronomía, Alta Cocina INTENSIVO</p>
                      </div>
                      <div class="folio-overview">
                         <span class="folio-link"><a  href="cursos.html" target="blank" data-single_url="cursos.html"><i class="fa fa-link"></i></a></span>
                        <span class="folio-expand"><a class="folio-read-more" href="#single-portfolio" data-toggle="collapse"><i class="fa fa-search-plus"></i></a></span>
